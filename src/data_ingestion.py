...
log_file_path = os.path.join(log_dir, 'data_ingestion.logs')
...
def load_data(data_url: str) -> pd.DataFrame:
    try:
        ...
        logger.error('Unexpected error occured while loading the CSV file %s', e)
        raise
...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    try:
        ...
        logger.error('Unexpected error while preprocessing')
        raise
...
def save_data(train_data: pd.DataFrame ,test_data: pd.DataFrame , data_path: str):
    try:
        ...
        logger.error('Unexpected error occured while saving the data %e', e)
